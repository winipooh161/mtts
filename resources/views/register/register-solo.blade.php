            ...
            <div class="form__register">
                ...
                <form id="sologooppu" action="{{ route('registerSoloCommand', ['id' => $game->id]) }}" method="POST">
                    ...
                    <label for="rank">
                        ...
                        <input type="text" name="rank" id="rank" placeholder="Введи информацию" maxlength="150"
                            required>
                        @error('rank')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <label for="time_game">
                        ...
                        <input type="text" name="time_game" id="time_game" placeholder="Введи информацию" maxlength="150"
                            required>
                        @error('time_game')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
