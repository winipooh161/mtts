@section('register-quizPage')
    <div class="container register__fon validreg   ">
        ...
        <div class="form__register">
            ...
            <form id="registration__form__group" action="{{ route('registerquizCommand', ['id' => $game->id]) }}" method="POST">
                @csrf
                @if (session('success'))
                ...
                <div class="block__fio">
                    <label for="name">
                        <p>Имя</p>
                        <input type="text" name="name" id="name" placeholder="Введи своё имя"
                    ...
                    <label for="surname">
                        <p>Фамилия</p>
                        <input type="text" name="surname" id="surname" placeholder="Введи свою фамилию"
                    ...
                    <label for="patronymic">
                        <p>Отчество</p>
                        <input type="text" name="patronymic" id="patronymic" placeholder="Введи своё отчество"
                ...
                <div class="block__combo">
                    <label for="discord">
                        <p>Discord</p>
                        <input type="text" name="discord" id="discord" placeholder="Введи свой @Discord"
                ...
                <label for="nickname">
                    ...
                    <input type="text" name="nickname" id="nickname" placeholder="Введи свой никнейм" maxlength="50"
                        required>
                    @error('nickname')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <label for="team_name">
                    ...
                    <input type="text" name="team_name" id="team_name" placeholder="Введи название команды"
                        maxlength="30" required>
                    @error('team_name')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <label for="rank">
                    ...
                    <input type="text" name="rank" id="rank" placeholder="Введи информацию"
                ...
                <label for="team_experience">
                    ...
                    <input type="text" name="team_experience" id="team_experience" placeholder="Введи информацию"
                        maxlength="150" required>
